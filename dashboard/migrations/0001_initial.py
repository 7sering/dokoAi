    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profileImage', django_resized.forms.ResizedImageField(crop=None, force_format='JPEG', keep_meta=True, quality=90, scale=0.5, size=[200, 200], upload_to='profile_image')),
